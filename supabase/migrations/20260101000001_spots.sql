-- Spoty: typy, tabulka, veřejné čtení schválených, seed 5 spotů. Idempotentní.
...
-- TODO: doplnit good_dirs / bad_dirs (viz audit – směr je teď neaktivní).
...
on conflict (id) do update set
  ...
  lon = excluded.lon, note = excluded.note, windguru_url = excluded.windguru_url,
  status = excluded.status, trust = excluded.trust;
